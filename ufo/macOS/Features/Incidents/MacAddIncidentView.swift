...
struct MacAddIncidentView: View {
...
private extension MacAddIncidentView {
...
@MainActor
func makeMacIncidentPreviewData() -> MacIncidentPreviewData {
    let schema = Schema([
        UserProfile.self,
        Space.self,
