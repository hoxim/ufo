...
struct MacAddSavedPlaceSheet: View {
    ...
    private func save() async {
        ...
        if let placeToEdit {
            ...
            Log.msg("MacAddSavedPlaceSheet.save creating title=\(cleanTitle) method=\(method.rawValue) selectedSpace=\(viewModel.locationStore?.currentSpaceId?.uuidString ?? "nil")")
