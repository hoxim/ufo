...
struct MacBudgetScreen: View {
    ...
    private var availableCategories: [String] {
        ...
        let values = Set(MacBudgetPresetCategory.allCases.map(\.title) + appPreferences.budgetCustomCategories + entryCategories + ruleCategories)
    ...
    private var categorySummaries: [MacBudgetCategorySummary] {
        ...
        return categories.map { point in
            MacBudgetCategorySummary(category: point.category, spent: point.amount, limit: point.limit)
        }
    }
