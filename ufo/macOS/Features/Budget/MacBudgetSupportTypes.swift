...
enum MacBudgetKindFilter: String, CaseIterable {
    case all
    case income
    case expense
...
enum MacBudgetRangeFilter: CaseIterable {
    case week
    case month
    case threeMonths
    case year
...
enum MacBudgetRecurringInterval: String, CaseIterable {
    case daily
    case weekly
    case monthly
    case yearly
...
enum MacBudgetPresetCategory: CaseIterable {
    case home
    case food
    case subscriptions
    case transport
...
enum MacBudgetPresetIncomeCategory: CaseIterable {
    case salary
    case freelance
    case refund
    case gift
...
struct MacBudgetCategorySummary: Identifiable {
    let category: String
    let spent: Double
    let limit: Double?
