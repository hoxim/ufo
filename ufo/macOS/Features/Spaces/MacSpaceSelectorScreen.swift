...
struct MacSpaceSelectorScreen: View {
...
#Preview("Light mode") {
    ...
    let spaces = MacSpaceMock.makeSampleData(context: context)
    let spaceRepo = SpaceRepository(client: SupabaseConfig.client)

    MacSpaceSelectorScreen(userSpaces: spaces)
