...
struct MacInviteMemberView: View {
    @Environment(\.dismiss) private var dismiss
    @Environment(SpaceRepository.self) private var spaceRepo

    let space: Space

    @State private var viewModel: MacInviteViewModel?
...
struct MacInviteForm: View {
    @Bindable var vm: MacInviteViewModel
    @Environment(\.dismiss) private var dismiss
