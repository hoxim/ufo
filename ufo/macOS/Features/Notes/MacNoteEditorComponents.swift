...
struct MacNoteEditorHeaderSection: View {
...
struct MacNoteEditorContentSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Group {
                if isPreviewMode {
                    MacNoteRichTextEditorRepresentable(
...
struct MacNoteEditorMetadataSection: View {
...
struct MacNoteEditorFormattingBar: View {
    let isPreviewMode: Bool
    let onHeading: () -> Void
    let onBold: () -> Void
    let onBullet: () -> Void
