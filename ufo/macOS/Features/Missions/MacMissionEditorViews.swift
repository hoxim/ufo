...
struct MacEditMissionView: View {
    ...
    private var resolvedAvailablePlaces: [SavedPlace] {
        MacMissionEditorSupport.resolvedPlaces(
    ...
    private var resolvedAvailableLists: [SharedList] {
        MacMissionEditorSupport.resolvedLists(
            modelContext: modelContext,
            spaceId: spaceRepo.selectedSpace?.id,
    ...
    private var resolvedAvailableNotes: [Note] {
        MacMissionEditorSupport.resolvedNotes(
            modelContext: modelContext,
            spaceId: spaceRepo.selectedSpace?.id,
    ...
    private var resolvedAvailableIncidents: [Incident] {
        MacMissionEditorSupport.resolvedIncidents(
            modelContext: modelContext,
            spaceId: spaceRepo.selectedSpace?.id,
...
private extension MacEditMissionView {
    var managedRelatedIds: [UUID] {
        MacMissionEditorSupport.managedRelatedIds(
...
private extension MacAddMissionView {
    var managedRelatedIds: [UUID] {
        MacMissionEditorSupport.managedRelatedIds(
            lists: resolvedAvailableLists,
            notes: resolvedAvailableNotes,
