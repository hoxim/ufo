...
struct MacMissionsScreen: View {
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $isAddingMission) {
            if let missionStore {
                MacAddMissionView(
                    store: missionStore,
        ...
        .navigationDestination(item: $editingMission) { mission in
            if let missionStore {
                MacEditMissionView(
                    store: missionStore,
                    mission: mission,
        ...
        .navigationDestination(item: $viewingMission) { mission in
