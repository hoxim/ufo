...
@MainActor
private struct PhoneListPreviewData {
...
@MainActor
private func makePhoneListPreviewData() -> PhoneListPreviewData {
    let schema = Schema([
        UserProfile.self,
        Space.self,
...
#Preview("Phone Add List") {
    let preview = makePhoneListPreviewData()
