...
struct PhoneMissionListRowView: View {
    let mission: Mission
...
private func makePhoneMissionRowPreviewMission() -> Mission {
    let mission = Mission(
        spaceId: UUID(),
...
#Preview("Phone Mission Row") {
    PhoneMissionListRowView(
        mission: makePhoneMissionRowPreviewMission(),
        onToggleCompleted: {},
        onOpen: {},
        onEdit: {},
        onDelete: {}
