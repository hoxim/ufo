...
private struct PhoneMissionEditorFormPreviewHost: View {
    ...
    @State private var ownerId: UUID? = PhoneMissionEditorPreviewData.owner.id
    @State private var dueDateEnabled = true
    @State private var dueDate = Date.now.addingTimeInterval(86_400)
    @State private var savedPlaceId: UUID? = PhoneMissionEditorPreviewData.place.id
    @State private var relatedListId: UUID? = PhoneMissionEditorPreviewData.list.id
    @State private var relatedNoteId: UUID? = PhoneMissionEditorPreviewData.note.id
    @State private var relatedIncidentId: UUID? = PhoneMissionEditorPreviewData.incident.id
    ...
    var body: some View {
        PhoneMissionEditorForm(
            ...
            imageData: $imageData,
            availablePlaces: [PhoneMissionEditorPreviewData.place],
            availableOwners: [PhoneMissionEditorPreviewData.owner],
            availableLists: [PhoneMissionEditorPreviewData.list],
            availableNotes: [PhoneMissionEditorPreviewData.note],
            availableIncidents: [PhoneMissionEditorPreviewData.incident],
            isSaving: false,
...
private enum PhoneMissionEditorPreviewData {
...
#Preview("Phone Mission Editor Form") {
    NavigationStack {
        PhoneMissionEditorFormPreviewHost()
    }
}
