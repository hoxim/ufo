...
struct PhoneAddIncidentView: View {
...
private extension PhoneAddIncidentView {
...
@MainActor
struct PhoneIncidentPreviewData {
...
@MainActor
func makePhoneIncidentPreviewData() -> PhoneIncidentPreviewData {
    let schema = Schema([
        UserProfile.self,
        Space.self,
    ...
    return PhoneIncidentPreviewData(
        container: container,
