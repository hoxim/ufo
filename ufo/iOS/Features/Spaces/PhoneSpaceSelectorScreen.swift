...
//
//  PhoneSpaceSelectorScreen.swift
//  ufo
//
...
struct PhoneSpaceSelectorScreen: View {
...
#Preview("Light mode") {
    ...
    let spaces = PhoneSpaceMock.makeSampleData(context: context)
    let spaceRepo = SpaceRepository(client: SupabaseConfig.client)

    PhoneSpaceSelectorScreen(userSpaces: spaces)
