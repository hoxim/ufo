...
struct PhoneSpacesScreen: View {
    ...
    @State private var pendingAction: PhoneSpacePendingAction?
    @State private var selectedFilter: PhoneSpaceFilter = .all
    ...
    private var filterBar: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 10) {
                ForEach(PhoneSpaceFilter.allCases) { filter in
                    Button {
    ...
    private func perform(_ action: PhoneSpacePendingAction) async {
