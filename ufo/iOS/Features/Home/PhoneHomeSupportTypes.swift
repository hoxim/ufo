...
#Preview("Phone Notification Bell") {
    VStack(spacing: 16) {
        PhoneNotificationBellButton(unreadCount: 0)
        PhoneNotificationBellButton(unreadCount: 7)
    }
    .padding()
    .background(AppTheme.Colors.canvas)
}

#Preview("Phone Active Space Button") {
    PhoneActiveSpaceMenuButton(
