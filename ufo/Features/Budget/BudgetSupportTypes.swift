...
enum BudgetKindFilter: String, CaseIterable {
    case all
    case income
    case expense
...
enum BudgetRangeFilter: CaseIterable {
    case month
    case threeMonths
    case year
    case all
...
enum BudgetRecurringInterval: String, CaseIterable {
    case weekly
    case monthly
    case yearly
...
enum BudgetPresetCategory: CaseIterable {
    case home
    case food
    case subscriptions
    case transport
...
enum BudgetPresetIncomeCategory: CaseIterable {
    case salary
    case freelance
    case refund
    case gift
