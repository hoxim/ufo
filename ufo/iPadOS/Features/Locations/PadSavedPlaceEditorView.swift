...
struct PadAddSavedPlaceSheet: View {
    ...
    private func save() async {
        ...
        if let placeToEdit {
            ...
            Log.msg("PadAddSavedPlaceSheet.save creating title=\(cleanTitle) method=\(method.rawValue) lat=\(selectedCoordinate.latitude) lon=\(selectedCoordinate.longitude) selectedSpace=\(viewModel.locationStore?.currentSpaceId?.uuidString ?? "nil")")
