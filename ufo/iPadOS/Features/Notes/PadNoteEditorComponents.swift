...
struct PadNoteEditorHeaderSection: View {
...
struct PadNoteEditorContentSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Group {
                if isPreviewMode {
                    PadNoteRichTextEditorRepresentable(
...
struct PadNoteEditorMetadataSection: View {
...
struct PadNoteEditorFormattingBar: View {
    let isPreviewMode: Bool
    let onHeading: () -> Void
    let onBold: () -> Void
    let onBullet: () -> Void
