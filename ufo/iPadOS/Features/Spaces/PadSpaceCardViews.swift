        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                if members.isEmpty {
                    ...
                    HStack(spacing: 10) {
                        PadOverlappingAvatars(members: members)
            ...
            if isExpanded {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    ForEach(members) { member in
                        PadSpaceMemberRow(member: member)
                    }
                }
...
struct PadSpaceMemberRow: View {
    let member: SpaceMemberRecipient

    var body: some View {
        HStack(spacing: 12) {
            PadSpaceMemberAvatar(member: member)
...
struct PadOverlappingAvatars: View {
    let members: [SpaceMemberRecipient]
...
struct PadSpaceMemberAvatar: View {
    let member: SpaceMemberRecipient
