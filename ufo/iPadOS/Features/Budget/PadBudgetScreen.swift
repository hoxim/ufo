...
struct PadBudgetScreen: View {
    ...
    private var availableCategories: [String] {
        ...
        let values = Set(PadBudgetPresetCategory.allCases.map(\.title) + appPreferences.budgetCustomCategories + entryCategories + ruleCategories)
    ...
    private var categorySummaries: [PadBudgetCategorySummary] {
        ...
        return categories.map { point in
            PadBudgetCategorySummary(category: point.category, spent: point.amount, limit: point.limit)
        }
    }
